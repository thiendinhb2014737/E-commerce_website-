...
import { convertDataChartShipped } from '../../utils';

const PieChartShippedComponent = (props) => {
    const data = convertDataChartShipped(props.data, 'statusOder')
...
export default PieChartShippedComponent