...
const DashedLine2022 = (props) => {
    const user = useSelector((state) => state?.user)

    // Tiền tháng 1
    const getPriceJan = async () => {
        const month = "January 2022"
