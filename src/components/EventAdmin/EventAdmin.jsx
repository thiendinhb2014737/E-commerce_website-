...
const EventAdmin = () => {
    ...
    const mutation = useMutationHooks(
        (data) => {
            ...
            const res = EventService.createEvent({ days, hours, minutes, seconds, eventName, discount })
            return res
        }
    )
    const mutationUpdate = useMutationHooks(
        (data) => {
            ...
            const res = EventService.UpdateEvent(id, { days, hours, minutes, seconds, eventName, discount })
            return res
        }
    )
    ...
    const handleCreatEvent = () => {
        mutation.mutate({ days: `${days?.$d}`.slice(0, 15), hours, minutes, seconds, eventName, discount })
    }
    const handleUpdateEvent = () => {
        mutationUpdate.mutate({ id: rowSelected, days: `${days?.$d}`.slice(0, 15), hours, minutes, seconds, eventName, discount }, {
            onSettled: () => {
                queryEvent.refetch()
            }
        })
    ...
    const dataTable = event?.data?.length && event?.data?.map((event) => {
        return {
            ...event,
            key: event._id,
        }
    ...
    return (
        <div>
                    ...
                    isModalOpen === true ? (
                        <div>
                            <WrapperContentTime>
                                ...
                                <InputFormComponents id="hours" style={{ width: '148px', height: '31.6px', }} placeholder="Nhập giờ" onChange={handleOnChangeHour} />
                                <InputFormComponents id="minutes" style={{ width: '148px', height: '31.6px', }} placeholder="Nhập phút" onChange={handleOnChangeMinute} />
                                <InputFormComponents id="seconds" style={{ width: '148px', height: '31.6px', }} placeholder="Nhập giây" onChange={handleOnChangeSecond} />
                                <ButtonComponents
                            ...
                            <WrapperContentTime>
                                <InputFormComponents id="event" style={{ width: '485px', height: '40px', }} placeholder="Nhập nội dung sự kiện" onChange={handleOnChangeEvent} />
                                <InputFormComponents id="discount" style={{ width: '148px', height: '40px', }} placeholder="Giảm giá (%)" onChange={handleOnChangeDiscount} />
                            </WrapperContentTime>
                            <WrapperContentTime>
                    ...
                    isModalOpenUpdate === true ? (
                        <div>
                            <WrapperContentTime>
                                ...
                                <InputFormComponents id="hours" style={{ width: '148px', height: '31.6px', }} value={hours} onChange={handleOnChangeHour} />
                                <InputFormComponents id="minutes" style={{ width: '148px', height: '31.6px', }} value={minutes} onChange={handleOnChangeMinute} />
                                <InputFormComponents id="seconds" style={{ width: '148px', height: '31.6px', }} value={seconds} onChange={handleOnChangeSecond} />
                                <ButtonComponents
                            ...
                            <WrapperContentTime>
                                <InputFormComponents id="event" style={{ width: '485px', height: '40px', }} value={eventName} onChange={handleOnChangeEvent} />
                                <InputFormComponents id="discount" style={{ width: '148px', height: '40px', }} value={discount} onChange={handleOnChangeDiscount} />
                            </WrapperContentTime>
                            <WrapperContentTime>
            ...
            <ModalComponents title="Xóa người sự kiện" open={isModalOpenDelete} onCancel={handleCancelDelete} onOk={handleDeleteEvent}>
